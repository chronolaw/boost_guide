...
void case4()
{
    ...
    typedef uint_t<15>::fast u15;                 //鍙绾�5浣嶇殑鏃犵鍙锋渶蹇暣鏁�
    cout << fmt % type_name<u15>() % (sizeof(u15) * 8) ;

    typedef int_max_value_t<32700>::fast i32700;     //鍙鐞�2700鐨勬渶蹇暣鏁�
    cout << fmt % type_name<i32700>() % (sizeof(i32700) * 8);

    typedef int_min_value_t<-33000>::fast i33000;        //鍙鐞�33000鐨勬渶蹇暣鏁�
    cout << fmt % type_name<i33000>() % (sizeof(33000) * 8);

    typedef uint_value_t<33000>::fast u33000;            //鍙鐞�3000鐨勬渶蹇棤绗﹀彿鏁存暟
